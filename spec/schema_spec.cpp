...
TEST_CASE("encoding") {
  ...
  SECTION("it encodes a struct") {
    ...
    unsigned char expected[] = {
      ...
      0x6c, 0x65, 0x00, 0x00, // "le", pad

      // crystalize_schema_field_t
      0x50, 0x00, 0x00, 0x00, // field0: name pointer relative offset (8 bytes)
      0x00, 0x00, 0x00, 0x00, // field0: (more pointer)
      0x02, 0x00, 0x00, 0x00, // field0: name_size
      ...
      0x00, 0x00, 0x00, 0x00, // field0: pad

      // crystalize_schema_field_t
      0x2a, 0x00, 0x00, 0x00, // field1: name pointer relative offset (8 bytes)
      0x00, 0x00, 0x00, 0x00, // field1: (more pointer)
      0x02, 0x00, 0x00, 0x00, // field1: name_size
      0xe5, 0x2d, 0x0c, 0xe7, // field1: fnv1a("b")
      0x00, 0x00, 0x00, 0x00, // field1: struct_name_id
      0x00, 0x00, 0x00, 0x00, // filed1: struct_version
      0x03, 0x00, 0x00, 0x00, // field1: count
      0x00, 0x00, 0x00, 0x00, // field1: count_field_name_id
      0x04, 0x00, 0x00, 0x00, // field1: type(int32) + pad
      0x00, 0x00, 0x00, 0x00, // field1: pad

      0x61, 0x00, 0x62, 0x00, // "a", "b"
